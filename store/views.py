...
def store(request, category_slug=None):
    ...
    if category_slug is not None:
        ...
        products = Product.objects.all().filter(is_available=True).order_by('id')  # Grab products if they are available
        product_count = products.count()  # Grab product count
        # Paginator logic
...
def product_detail(request, category_slug, product_slug):
    ...
    # Grab data from products already purchased
